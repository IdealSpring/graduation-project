...
public class AttributeUtils {
	 ...
	 *
	 * @param enterprise	企业信息
	 * @param inputIfo		进项信息集合
	 * @param outputIfo	销项信息集合
	 */
     ...
     * @param outputInvoiceSet	销项发票集合
     */
    public static void setInvoiceUsageChange(Enterprise enterprise,
                                             TreeSet<Invoice> inputInvoiceSet,
                                             TreeSet<Invoice> outputInvoiceSet) {
    ...
    /**
     * 提取:9.inputTaxAndOutputTaxRatio
	 * 		进项税额变动率高于销项税额变动率
     *
     * @param enterprise	企业信息
     * @param inputInvoiceSet		进项发票集合
     * @param outputInvoiceSet	销项发票集合
     */
    public static void setInputTaxAndOutputTaxRatio(Enterprise enterprise,
                                                    TreeSet<Invoice> inputInvoiceSet,
                                                    TreeSet<Invoice> outputInvoiceSet) {
     ...
     *
     * @param enterprise	企业信息
     * @param inputTaxMap		进项发票集合
     * @param outputTaxMap	销项发票集合
     */
     ...
     * @param outputInvoiceSet	销项发票集合
     */
    public static void setInvoiceInvalidRatio(Enterprise enterprise,
                                              TreeSet<Invoice> inputInvoiceSet,
                                              TreeSet<Invoice> outputInvoiceSet) {
        TreeSet<Invoice> invoices = new TreeSet<>();
        invoices.addAll(inputInvoiceSet);
	...
	/**
	 * 提取:16.inputAndOutputDeviation
	 * 		进销项偏离指数(近半年)
	 *
	 * @param detailsExtraction	货物明细
	 * @param inputDetailsSet		进项货物明细集合
	 * @param outputDetailsSet	销项货物明细集合
	 * @param spbmRange	类别
	 */
    ...
    /**
     * 提取:属性19:redInvoiceQuantityRate  红字发票数量占比
     *      属性22:valueOfRedInovice  红字发票金额
     *
     * @param enterprise
	...
	/**
	 * 提取:21.numberDifferenceOfInputAndOutput
	 * 		进销项发票数量差
	 *
	 * @param enterprise	企业信息
	 * @param inputInvoiceSet		进项发票集合
