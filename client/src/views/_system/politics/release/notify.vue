<template>
  <div class="app-container">
    ...
    <!--按钮-->
    <el-button type="primary" icon="el-icon-plus" size="mini" v-if="hasFilePerm()" @click="handleCreate()">发布通知
    </el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 有操作权限
      hasFilePerm() {
        return this.currentRole.perms.some(p => p.val == 'm:politics:report')
      },
      ...
      // 初始化数据
      initData() {
        this.tableQuery.politicsType = 'notify'
      },
